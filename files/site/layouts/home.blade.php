                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                    <div class="full">
                        <div class="center-desk">
                            <div class="logo">
                                <a href="index.html"><img src="images/alice.png" width="150px" height="100%" alt="#" /></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                    <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                            ...
                            <div class="sign_btn"><a href="{{ route('registration') }}">Sign in</a></div>
                        </div>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="text-bg">
                    <div class="padding_lert">
                        <h1>WELCOME TO HOTEL Alice </h1>
                        <span>LANDING PAGE 2022</span>
                        <p>
                            A hotel with 39 Remarkable Rooms in the Center of Old Yerevan.<br>
                            Book direct now, get special offers!<br>
                            No reservation fee!</p>
...
{{--                        </div>--}}
                        <div class="sign_btn"><a href="{{ route('book') }}"> Book Now </a></div>
                    </div>
                    </div>
                </form>
            </div>
